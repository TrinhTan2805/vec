...
const mockData: DoanDiaPhan[] = [
  { id: "1", maDoan: "DP-001", tenDoan: "Đoạn qua Q. Cầu Giấy", tuyenDuong: "QL1A", donViQL: "Sở GTVT Hà Nội", loaiDuong: "Đường đô thị", capDuong: "Cấp I", bacDuong: "Bậc 1", capKT: "TCVN 4054:2005", capQH: "2030", diemDau: "Cầu Giấy", diemCuoi: "Mai Dịch", chieuDai: 3.2, trangThai: "Hoạt động" },
  { id: "2", maDoan: "DP-002", tenDoan: "Đoạn qua Bắc Từ Liêm", tuyenDuong: "QL1A", donViQL: "Sở GTVT Hà Nội", loaiDuong: "Đường chính", capDuong: "Cấp II", bacDuong: "Bậc 2", capKT: "TCVN 4054:2005", capQH: "2030", diemDau: "Mai Dịch", diemCuoi: "Cầu Thăng Long", chieuDai: 5.8, trangThai: "Hoạt động" },
  { id: "3", maDoan: "DP-003", tenDoan: "Đoạn qua Mê Linh", tuyenDuong: "QL1A", donViQL: "Sở GTVT Hà Nội", loaiDuong: "Đường phụ", capDuong: "Cấp III", bacDuong: "Bậc 3", capKT: "TCVN 4054:2005", capQH: "2030", diemDau: "Cầu Thăng Long", diemCuoi: "Mê Linh", chieuDai: 12.5, trangThai: "Bảo trì" },
];

export default function DoanDiaPhanList() {
  ...
  // New states for Merge and Split
  ...
  const stats = [
    { 
      label: "Tổng số đoạn đường theo địa phận", 
      value: "856 đoạn", 
      change: "24 đoạn", 
      trend: "up" as const, 
    ...
    { 
      label: "Đoạn đường địa phận thêm mới 2026", 
      value: "42 đoạn", 
      change: "8%", 
      trend: "up" as const, 
    ...
    { 
      label: "Đoạn đường địa phận đến hạn bảo trì", 
      value: "18 đoạn", 
      change: "3 xu hướng", 
      trend: "down" as const, 
    ...
    { 
      label: "Tổng số km đoạn địa phận", 
      value: "1,230 km", 
      change: "45 km", 
      trend: "up" as const, 
  ...
  return (
    <div className="space-y-6">
        ...
        <CardContent className="pt-6">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div className="flex flex-1 items-center gap-2">
              ...
              <Input placeholder="Tìm kiếm đoạn theo địa phận..." className="max-w-sm" />
            </div>
      ...
      <Card>
        <CardHeader><CardTitle>Danh sách đoạn đường theo địa phận</CardTitle></CardHeader>
        <CardContent>
          <Table>
      ...
      <DetailDialog 
        ...
        selectedCard={{ title: "Đoạn đường theo địa phận" }}
      ...
      <Dialog open={isMergeDialogOpen} onOpenChange={setIsMergeDialogOpen}>
        <DialogContent className="max-w-md">
          ...
          <div className="py-4 space-y-4">
            <p className="text-sm text-slate-600">Bạn đang chọn gộp <strong>{selectedIds.length}</strong> đoạn đường theo địa phận thành một đoạn duy nhất. Hãy nhập Tên đoạn mới:</p>
            <div className="space-y-2">
              <Label>Tên đoạn đường (sau khi gộp) <span className="text-red-500">*</span></Label>
              <Input placeholder="Nhập tên đoạn mới..." />
            </div>
            <p className="text-xs text-orange-600 italic">* Các thông tin kỹ thuật, hồ sơ hoàn công và lịch sử bảo trì sẽ được tổng hợp lại.</p>
          </div>
          <DialogFooter>
      ...
      <Dialog open={isSplitDialogOpen} onOpenChange={setIsSplitDialogOpen}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Chia tách đoạn {splitItem?.tenDoan} thành một hoặc nhiều đoạn đường mới. Đoạn gốc vẫn được giữ nguyên.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-6 py-4">
            <div className="flex justify-between items-center bg-indigo-50 p-4 rounded-lg border border-indigo-100">
              <div>
                <p className="text-xs text-indigo-600 font-semibold uppercase tracking-wider mb-1">Lý trình hiện tại (Dự kiến)</p>
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                <Label className="text-sm font-bold text-slate-700">Định nghĩa các đoạn con mới</Label>
                <Button 
                  variant="outline" 
                  size="sm" 
          ...
          <DialogFooter className="bg-slate-50 p-6 -mx-6 -mb-6 border-t mt-4 rounded-b-lg">
            ...
            <Button className="bg-indigo-600 hover:bg-indigo-700 text-white" onClick={() => {
              alert(`Xác nhận tách thành ${splitSegments.length} đoạn con. Dữ liệu đã được cập nhật hệ thống.`);
