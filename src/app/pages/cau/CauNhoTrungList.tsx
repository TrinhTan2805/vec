...
import { Search, Plus, Edit, Trash2, Download, Eye, Upload, LayoutDashboard, Layers , Map as MapIcon} from "lucide-react";
...
const mockData: CauNhoTrung[] = [
  { id: "1", maCau: "BR-S-001", tenCau: "Cầu Trắng", tuyenDuong: "QL6", lyTrinh: "Km 10+200", chieuDai: "15 m", chieuRong: "8 m", donViQL: "Sở GTVT Hà Nội", trangThai: "Hoạt động" },
  { id: "2", maCau: "BR-M-001", tenCau: "Cầu Đen", tuyenDuong: "QL32", lyTrinh: "Km 15+500", chieuDai: "45 m", chieuRong: "12 m", donViQL: "Sở GTVT Hà Nội", trangThai: "Hoạt động" },
];

export default function CauNhoTrungList() {
  const [viewMode, setViewMode] = useState<"list" | "map">("list");
  const [data, setData] = useState<CauNhoTrung[]>(mockData);
  const [searchTerm, setSearchTerm] = useState("");

  const [isDetailDialogOpen, setIsDetailDialogOpen] = useState(false);
  const [isImportDialogOpen, setIsImportDialogOpen] = useState(false);
  const [selectedItem, setSelectedItem] = useState<CauNhoTrung | null>(null);
  ...
  return (
    <div className="space-y-6">
        ...
        <CardContent className="pt-6">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div className="flex flex-1 items-center gap-2">
              ...
              <Input
                placeholder="Tìm kiếm cầu nhỏ, trung..."
                value={searchTerm}
      ...
      {viewMode === "list" && (
        <Card>
        <CardHeader>
          <CardTitle>Danh sách Cầu nhỏ, trung ({filteredData.length})</CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <DetailDialog
        ...
        selectedCard={{ title: "Cầu nhỏ, trung" }}
        onEditClick={() => {}}
      />
      ...
      <ImportDialog
        ...
        title="Nhập dữ liệu Cầu nhỏ, trung"
        fields={bridgeFields}
        onImportComplete={() => {}}
      />
    </div>
