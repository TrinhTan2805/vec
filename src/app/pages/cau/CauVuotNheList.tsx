...
import { Search, Plus, Edit, Trash2, Download, Map, Eye, Upload, LayoutDashboard, Layers , Map as MapIcon} from "lucide-react";
...
const mockData: CauVuotNhe[] = [
  { id: "1", maCau: "BR-L-001", tenCau: "Cầu vượt Thái Hà - Chùa Bộc", tuyenDuong: "Thái Hà", lyTrinh: "Km 0+200", chieuDai: "250 m", chieuRong: "9 m", donViQL: "Sở GTVT Hà Nội", trangThai: "Hoạt động" },
  { id: "2", maCau: "BR-L-002", tenCau: "Cầu vượt Láng Hạ - Lê Văn Lương", tuyenDuong: "Láng Hạ", lyTrinh: "Km 1+500", chieuDai: "320 m", chieuRong: "12 m", donViQL: "Sở GTVT Hà Nội", trangThai: "Hoạt động" },
];

export default function CauVuotNheList() {
  const [viewMode, setViewMode] = useState<"list" | "map">("list");
  const [data, setData] = useState<CauVuotNhe[]>(mockData);
  const [searchTerm, setSearchTerm] = useState("");
  const [isDetailDialogOpen, setIsDetailDialogOpen] = useState(false);
  const [isImportDialogOpen, setIsImportDialogOpen] = useState(false);
  const [selectedItem, setSelectedItem] = useState<CauVuotNhe | null>(null);
  ...
  return (
    <div className="space-y-6">
        ...
        <CardContent className="pt-6">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div className="flex flex-1 items-center gap-2">
              ...
              <Input
                placeholder="Tìm kiếm cầu vượt nhẹ..."
                value={searchTerm}
      ...
      {viewMode === "list" && (
        <Card>
        <CardHeader>
          <CardTitle>Danh sách Cầu vượt nhẹ ({filteredData.length})</CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <DetailDialog
        ...
        selectedCard={{ title: "Cầu vượt nhẹ" }}
        onEditClick={() => {}}
      />
      ...
      <ImportDialog
        ...
        title="Nhập dữ liệu Cầu vượt nhẹ"
        fields={bridgeFields}
        onImportComplete={() => {}}
      />
    </div>
