...
const mockData: any[] = [
  { 
    ...
    chieuDai: "150", 
    viTri: "Bên phải", 
    loaiHoLan: "Hộ lan tôn sóng",
    trangThai: "Tốt",
    ngayApDung: "01/01/2024",
    ghiChu: "Hộ lan tôn sóng 2 tầng, tình trạng ổn định."
  },
];

export default function LanCanList() {
  ...
  const fields = [
    ...
    { name: "loaiHoLan", label: "Loại hộ lan" },
  ...
  return (
    <div className="space-y-6">
      ...
      {viewMode === "list" && (
        <Card>
        <CardHeader>
          <CardTitle>Danh sách Lan can phòng hộ ({filteredData.length})</CardTitle>
        </CardHeader>
        <CardContent>
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead>Loại hộ lan</TableHead>
              ...
              <TableBody>
                {filteredData.map((item) => (
                  <TableRow key={item.id}>
                    ...
                    <TableCell>{item.loaiHoLan}</TableCell>
      ...
      <DetailDialog
        ...
        selectedItem={selectedItem ? { ...selectedItem, fullName: `Lan can ${selectedItem.lyTrinh}`, idNumber: selectedItem.id, status: selectedItem.trangThai } : null}
        selectedCard={{ title: "Lan can phòng hộ" }}
        onEditClick={() => {}}
      />
